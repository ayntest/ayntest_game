...
core.register_node("cottages:barrel", {
	...
	--                    core.add_node(pos, {name = "cottages:barrel_open", param2 = node.param2})
	--                end,
	-- TODO: on_rightclick is no longer available - maybe open if empty and closed if full?
	on_punch      = function(pos, node, puncher)
		core.add_node(pos, {name = "cottages:barrel_lying", param2 = node.param2})
	end,
...
core.register_node("cottages:barrel_open", {
	...
	drop = "cottages:barrel",
	--on_rightclick = function(pos, node, puncher)
	--	core.add_node(pos, {name = "cottages:barrel", param2 = node.param2})
	--end,
	on_punch      = function(pos, node, puncher)
		core.add_node(pos, {name = "cottages:barrel_lying_open", param2 = node.param2})
	end,
})

-- horizontal barrel
core.register_node("cottages:barrel_lying", {
	...
	on_punch      = function(pos, node, puncher)
		if( node.param2 < 4 ) then
		   core.add_node(pos, {name = "cottages:barrel_lying", param2 = (node.param2+1)})
		else
		   core.add_node(pos, {name = "cottages:barrel", param2 = 0})
		end
	end,
})

core.register_node("cottages:barrel_lying_open", {
	...
	node_box = {
		type = "fixed",
		fixed = barrel.make_pipe( { {f=0.9,h1=-0.2,h2=0.2,b=0}, {f=0.75,h1=-0.50,h2=-0.35,b=0}, {f=0.75,h1=0.35,h2=0.5,b=0},
								{f=0.82,h1=-0.35,h2=-0.2,b=0},  {f=0.82,h1=0.2, h2=0.35,b=0}, {f=0.75,h1=-0.42,h2=-0.37,b=1}}, 1
								), -- bottom closed
	},
	groups = {
		tree = 1,
	...
	on_punch = function(pos, node, puncher)
		if( node.param2 < 4 ) then
		   core.add_node(pos, {name = "cottages:barrel_lying_open", param2 = (node.param2+1)})
		else
		   core.add_node(pos, {name = "cottages:barrel_open", param2 = 0})
		end
	end,
	is_ground_content = false,
})
...
core.register_node("cottages:tub", {
	...
	node_box = {
		...
		fixed = barrel.make_pipe(
			{ {f=1.0,h1=-0.5,h2=0.0,b=0}, {f=1.0,h1=-0.46,h2=-0.41,b=1}}, 0
		),
	},
	groups = {
		tree = 1,
