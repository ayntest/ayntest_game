...
if not minetest.setting_getbool("creative_mode") then
	...
	if minetest.setting_getbool("spawn_hostile_mobs") ~= false then
		...
		local tn = { 'default:jungletree' }
		mobs:register_spawn('mobs:dirt_monster', 'Dirt monster',		mn, 1, -1, 50000, 6, 0, true)
		mobs:register_spawn('mobs:stone_monster', 'Stone monster',		mn, 1, -1, 50000, 4, 0, true)
		mobs:register_spawn('mobs:sand_monster', 'Sand monster',		sn, 1, -1, 50000, 4, -10, true)
		mobs:register_spawn('mobs:oerkki', 'Oerkki',					mn, 1, -1, 20000, 4, -1500, true)
		mobs:register_spawn('mobs:tree_monster', 'Tree monster',		tn, 1, -1, 40000, 2, 0, true)
		mobs:register_spawn('mobs:dungeon_master', 'Dungeon master',	mn, 1, -1, 30000, 2, -2500, true)
