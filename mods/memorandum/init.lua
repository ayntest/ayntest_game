...
minetest.register_node("memorandum:letter_empty", {
	...
	on_receive_fields = function(pos, formname, fields, sender)
		local meta = minetest.get_meta(pos)
		-- another nil value workaround!
		fields.text = fields.text or ''
		fields.signed = fields.signed or ''
		core.log("action", (sender:get_player_name() or '')..' wrote "'..fields.text..'" to paper at '..minetest.pos_to_string(pos) )
