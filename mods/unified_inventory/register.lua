...
unified_inventory.register_button('spawn_gui_go', {
	type = 'image',
	image = "ui_gospawn_icon.png",
	tooltip = S('Go to spawn'),
...
@@@@@ ]]--
unified_inventory.register_button( 'mypos', {
	type = "image",
	image = "ui_pos_icon.png",
	tooltip = 'Show my position (for tablets)',
	action = function(player)
		local player_name = player:get_player_name()
		local pos = default.floor_pos( player:getpos() )
		minetest.chat_send_player( player_name, 'Your position: ' .. pos )
	end,
})
